...
import TallyMapperCostcenterTable from "../../../components/Table/TallyCostcenterTable";
import TallyMapperCategoriesTable from "../../../components/Table/TallyCategoriesTable";
import TallyMapperLedgerTable from "../../../components/Table/TallyLedgerTable";
import TallyMapperLedgerGroupTable from "../../../components/Table/TallyLedgerGroupTable";
import TallyMapperVoucherTable from "../../../components/Table/TallyVoucherTable";
...
const TallyMapperMasterView = ({
	...
	const tabs = [
		...
		{
			label: "Ledger",
			table: <TallyMapperLedgerTable tableFilterList={deliverableUnitFilterList} />,
			// createButtons: [],
			// buttonAction: {
			// 	dialog: ({ open, handleClose }: { open: boolean; handleClose: () => void }) => (
			// 		<GeographiesDistrict
		...
		{
			label: "Ledger Groups",
			table: <TallyMapperLedgerGroupTable tableFilterList={deliverableUnitFilterList} />,
			// createButtons: [],
			// buttonAction: {
			// 	dialog: ({ open, handleClose }: { open: boolean; handleClose: () => void }) => (
			// 		<GeographiesBlock
		...
		{
			label: "Voucher Type",
			table: <TallyMapperVoucherTable tableFilterList={deliverableUnitFilterList} />,
			createButtons: [],
			buttonAction: {
				dialog: ({ open, handleClose }: { open: boolean; handleClose: () => void }) => (
...
export default TallyMapperMasterView;
