...
function GeographiesMasterContainer() {
	const [geoGraphiesFilterList, setGeographiesFilterList] = useState<{
	...
	const removeFilteListElements = (elementToDelete: keyof { [key: string]: string }) => {
		value === 0 &&
			setGeographiesFilterList((geoGraphiesFilterListObject) => {
				geoGraphiesFilterListObject[elementToDelete] = "";
				return { ...geoGraphiesFilterListObject };
			});
	...
	return (
		...
		<GeographiesMasterView
			...
			setDeliverableCategoryFilterList={setGeographiesFilterList}
