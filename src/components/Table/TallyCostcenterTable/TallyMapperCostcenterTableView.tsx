...
import { TallyMapperCostcenterTableHeading as tableHeadings } from "../constants";
...
function TallyMapperCostcenterTableView({
	...
	useEffect(() => {
		if (geographiesCountryEditAccess) {
			geographiesCountryTableEditMenu[0] = "Modify";
		}
	}, [geographiesCountryEditAccess]);
...
export default TallyMapperCostcenterTableView;
