...
import TallyMapperCostcenterTableView from "./TallyMapperCostcenterTableView";
...
function TallyMapperCostcenterTableContainer({
	...
	return (
		<TallyMapperCostcenterTableView
...
export default TallyMapperCostcenterTableContainer;
