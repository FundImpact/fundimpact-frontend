...
import TallyMapperCategoriesTableView from "./TallyMapperCategoriesTableView";
import {
	IGeographiesState,
...
function TallyMapperCategoriesTableContainer({
	...
	return (
		<TallyMapperCategoriesTableView
...
export default TallyMapperCategoriesTableContainer;
