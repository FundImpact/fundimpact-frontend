...
import TallyMapperVoucherTableView from "./TallyMapperVoucherTableView";
import {
...
function TallyMapperVoucherTableContainer({
...
export default TallyMapperVoucherTableContainer;
