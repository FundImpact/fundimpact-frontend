...
export enum MODULE_CODES {
	...
	GEOGRAPHIES_COUNTRY = "blocks",
	GEOGRAPHIES_STATE = "state",
	GEOGRAPHIES_DISTRICT = "district",
	GEOGRAPHIES_BLOCK = "block",
	GEOGRAPHIES_GRAMPANCHAYAT = "grampanchayat",
	GEOGRAPHIES_VILLAGE = "village",
