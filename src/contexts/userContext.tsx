...
interface IUserProviderProps {
  ...
  defaultState?: IUserDataContext;
}
 
function UserProvider({ children, defaultState }: IUserProviderProps) {
  const [state, reducer] = React.useReducer(userReducer, defaultState || getDefaultUserState());
  return (
